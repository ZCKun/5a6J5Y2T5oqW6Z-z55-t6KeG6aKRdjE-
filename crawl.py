...
if __name__ == "__main__":
    main()
    # a = get_name(1575302946, '1575302946063wifi1128awemewandoujia6unknown69143529399androidunknown44088263783316zh16600ffa82bd3b11065942891080*2029no_retryefc84c17a1575302946016621661.6.60.13333333333333333')
    # print(a)
    # p = 'https://api.amemv.com/aweme/v1/aweme/stats/?manifest_version_code=166&_rticket=1575271469986&ac=wifi&device_id=69143529399&iid=88263783316&os_version=9&channel=wandoujia&version_code=166&device_type=MI+MAX+3&language=zh&uuid=868695035559432&resolution=1080*2029&openudid=ffa82bd3b1106594&update_version_code=1662&app_name=aweme&version_name=1.6.6&os_api=28&device_brand=Xiaomi&ssmix=a&device_platform=android&dpi=440&aid=1128&ts=1575271470'
    # print(params_process(p2d(p.split('?')[1])))
